          ...
          return (
            <div key={index}>
              <Marker
                ...
                icon={iconPickup}
                draggable={selectedLivraison?.id === livraison.id && !isAssigned} // Rend le marqueur draggable uniquement si la livraison n'est pas assignée et est déjà sélectionnée
                eventHandlers={{
                  dragend: (e) =>
              ...
              <Marker
                ...
                icon={iconDelivery}
                draggable={selectedLivraison?.id === livraison.id && !isAssigned} // Rend le marqueur draggable uniquement si la livraison n'est pas assignée
                eventHandlers={{
